...
public class TransferEntity {
  ...
  public TransferGet getTransferBatch() {
    return transfer;
  }

  public void setTransferBatch(TransferGet transfer) {
  ...
  public String toString() {
    ...
    sb.append("    transferBatch: ").append(toIndentedString(transfer)).append("\n");
